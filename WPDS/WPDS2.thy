...
interpretation augmented_WPDS: WPDS_with_empty_W_automata augmented_WPDS_rules
  unfolding WPDS_with_empty_W_automata_def WPDS_def by (fact finite_augmented_WPDS_rules)
